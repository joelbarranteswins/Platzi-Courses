...
![imgs/Atributos-rdb.png](imgs/Atributos-rdb.png)
...
![imgs/entidades_debiles.png](imgs/entidades_debiles.png)

![imgs/entidades_debiles_2.png](imgs/entidades_debiles_2.png)
...
![imgs/entidades_platziblog.png](imgs/entidades_platziblog.png)

- Segundo paso: Pensar en los atributos.

![imgs/entidades_platziblog_2.png](imgs/entidades_platziblog_2.png)

![imgs/entidades_platziblog_3.png](imgs/entidades_platziblog_3.png)

### Clase 6 Relaciones

Las **relaciones** nos permiten ligar o unir nuestras diferentes entidades y se representan con rombos. Por convención se definen a través de verbos.

![imgs/relaciones.png](imgs/relaciones.png)
...
![imgs/cardinalidad_1_1.png](imgs/cardinalidad_1_1.png)
...
![imgs/cardinalidad_0_1.png](imgs/cardinalidad_0_1.png)

#### Cardinalidad: 1 a N (1 a muchos)

Un automóvil tiene N automóviles, pero 1 automóvil solo tiene 1 dueño.

![imgs/cardinalidad_1_N.png](imgs/cardinalidad_1_N.png)

#### Cardinalidad: 0 a N

![imgs/cardinalidad_0_N.png](imgs/cardinalidad_0_N.png)
...
![imgs/cardinalidad_N_N.png](imgs/cardinalidad_N_N.png)

### Clase 8 Diagrama ER

Un diagrama es como un mapa y nos ayuda a entender cuáles son las entidades con las que vamos a trabajar, cuáles son sus relaciones y qué papel van a jugar en las aplicaciones de la base de datos.

![imgs/diagrama_ER.png](imgs/diagrama_ER.png)
...
1. **Texto:** CHAR(n), VARCHAR(n), TEXT
2. **Números:** INTEGER, BIGINT, SMALLINT, DECIMAL(n,s), NUMERIC(n,s)
3. **Fecha/hora:** DATE, TIME, DATETIME, TIMESTAMP
4. **Lógicos:** BOOLEAN
...
![imgs/diagrama_fisico_sin_normalizar.png](imgs/diagrama_fisico_sin_normalizar.png)

**Primera forma normal (1FN):** Atributos atómicos (Sin campos repetidos)

![imgs/diagrama_fisico_1N.png](imgs/diagrama_fisico_1N.png)

**Segunda forma normal (2FN):** Cumple 1FN y cada campo de la tabla debe depender de una clave única.

![imgs/diagrama_fisico_2N.png](imgs/diagrama_fisico_2N.png)

**Tercera forma normal (3FN):** Cumple 1FN y 2FN y los campos que NO son clave, NO deben tener dependencias.

![imgs/diagrama_fisico_3N.png](imgs/diagrama_fisico_3N.png)

**Cuarta forma normal (4FN):** Cumple 1FN, 2FN, 3FN y los campos multivaluados se identifican por una clave única.

![imgs/diagrama_fisico_4N.png](imgs/diagrama_fisico_4N.png)
...
![imgs/Diagrama_Fisico_paso_1.png](imgs/Diagrama_Fisico_paso_1.png)

#### Diagrama fisico Paso 2

Genera las relaciones entre cada entidad y asigna PK y FK.

![imgs/diagrama_fisico_paso_2.png](imgs/diagrama_fisico_paso_2.png)

#### Diagrama fisico Paso 3

![imgs/diagrama_fisico_paso_2_N_N.png](imgs/diagrama_fisico_paso_2_N_N.png)

Para manejar las relaciones muchos a muchos, es necesario generar una tabla intermedia de esta manera.

![imgs/diagrama_fisico_paso_3_N_N.png](imgs/diagrama_fisico_paso_3_N_N.png)
...
![diagrama_fisico_1N.png](imgs/diagrama_fisico_1N.png)
...
![diagrama_fisico_2N.png](imgs/diagrama_fisico_2N.png)
...
![diagrama_fisico_3N.png](imgs/diagrama_fisico_3N.png)
...
![diagrama_fisico_4N](imgs/diagrama_fisico_4N.png)
...
Link
[https://dev.mysql.com/downloads/windows/installer/5.6.html](https://dev.mysql.com/downloads/windows/installer/5.6.html)
...
![Instalador_mysql_1](imgs/Instalador_mysql_1.png)
![Instalador_mysql_2](imgs/Instalador_mysql_2.png)
![Instalador_mysql_3](imgs/Instalador_mysql_3.png)
...
![worckbench_1](imgs/worckbench_1.png)

![worckbench_2](imgs/worckbench_2.png)

![worckbench_3](imgs/worckbench_3.png)
...
![SQL_create_database](imgs/SQL_create.png)

![SQL_create](imgs/SQL_create_database.png)

Seleccionamos el schema  como default, de forma gráfica aunque con la terminal seria el use database.

![worckbench_default_schema.png](imgs/worckbench_default_schema.png)

El comando Create Table

![create_table_slide](imgs/create_table_slide.png)

El creamos con workbench la tabla anterior, definimos  cada uno de los campos de manera sencilla posterior damos apply

![worckbench_new_table_1.png](imgs/worckbench_new_table_1.png)

![worckbench_new_table_2_apply.png](imgs/worckbench_new_table_2_apply.png)

![worckbench_new_table_3.png](imgs/worckbench_new_table_3.png)

### Clase 21 CREATE VIEW y DDL ALTER

#### Create view

![workbench_create_view.png](imgs/workbench_create_view.png)
...
![create_view1](imgs/create_view1.png)

![create_view2](imgs/create_view2.png)

![create_view3](imgs/create_view3.png)

![create_view4](imgs/create_view4.png)
...
![alter_table_1](imgs/alter_table_1.png)

![alter_table_2](imgs/alter_table_2.png)

![alter_table_3](imgs/alter_table_3.png)

![alter_table_4](imgs/alter_table_4.png)
...
![drop_column_1](imgs/drop_column_1.png)

![drop_column_1](imgs/drop_column_2.png)
...
![drop_table](imgs/drop_table.png)

![drop_table_1](imgs/drop_table_1.png)

![drop_table_2](imgs/drop_table_2.png)

![drop_table_3](imgs/drop_table_3.png)

Pasos para borrar la base de datos o schema

![drop_schema_1](imgs/drop_schema_1.png)

![drop_schema_2](imgs/drop_schema_2.png)

![drop_schema_3](imgs/drop_schema_3.png)

![drop_schema_4](imgs/drop_schema_4.png)
...
![insert_command.png](imgs/insert_command.png)
...
![insert_command_1.png](imgs/insert_command_1.png)

![insert_command_2.png](imgs/insert_command_2.png)

#### Update

![update_command.png](imgs/update_command.png)
...
![update_command_1.png](imgs/update_command_1.png)

![update_command_2.png](imgs/update_command_2.png)
...
![delete__command_1.png](imgs/delete__command_1.png)

#### Select

![select_command.png](imgs/select_command.png)

```sql
SELECT first_name, last_name FROM people;
```

![select_command_1.png](imgs/select_command_1.png)
...
![diagrama_fisico_paso_2](imgs/diagrama_fisico_paso_2.png)

Creamos el schema `platziblog` y seleccionamos como default y creamos las siguientes tablas

- categorías

![platziblog_tabla_etiquetas_1](imgs/platziblog_tabla_caracteristicas_1.png)

![platziblog_tabla_caracteristicas_2](imgs/platziblog_tabla_caracteristicas_2.png)

Creamos de igual forma la tabla Etiquetas

![platziblog_tabla_etiquetas_1](imgs/platziblog_tabla_etiquetas_1.png)

![platziblog_tabla_etiquetas_2](imgs/platziblog_tabla_etiquetas_2.png)

Tabla Usuarios

![platziblog_tabla_usuarios_1.png](imgs/platziblog_tabla_usuarios_1.png)

![platziblog_tabla_usuarios_2.png](imgs/platziblog_tabla_usuarios_2.png)
...
![platziblog_tabla_post_1.png](imgs/platziblog_tabla_post_1.png)

![platziblog_tabla_post_2.png](imgs/platziblog_tabla_post_2.png)

Vamos a la pestaña Foreign Key y asignamos las relaciones.

Asignamos la llave foranea del usuario_id

![platziblog_tabla_post_fk_usuario_id.png](imgs/platziblog_tabla_post_fk_usuario_id.png)

![platziblog_tabla_post_fk_categorias_id.png](imgs/platziblog_tabla_post_fk_categorias_id.png)

![platziblog_tabla_post_fk_categorias_id_1.png](imgs/platziblog_tabla_post_fk_categorias_id_1.png)
...
![platziblog_tabla_comentarios.png](imgs/platziblog_tabla_comentarios.png)

![platziblog_tabla_comentarios_1.png](imgs/platziblog_tabla_comentarios_1.png)

Creamos las llaves foráneas para los comentarios de los usuarios

![platziblog_tabla_comentarios_usuarios_fk_1.png](imgs/platziblog_tabla_comentarios_usuarios_fk_1.png)

![platziblog_tabla_comentarios_usuarios_fk_2.png](imgs/platziblog_tabla_comentarios_usuarios_fk_2.png)
...
![diagrama_fisico_paso_3_N_N.png](imgs/diagrama_fisico_paso_3_N_N.png)

Para ello creamos la tabla intermedia post_etiquetas

![platziblog_tabla_post_etiquetas.png](imgs/platziblog_tabla_post_etiquetas.png)

![platziblog_tabla_post_etiquetas_1.png](imgs/platziblog_tabla_post_etiquetas_1.png)

Ligamos las llaves foráneas para post_id

![platziblog_tabla_post_etiquetas_fk_1.png](imgs/platziblog_tabla_post_etiquetas_fk_1.png)

![platziblog_tabla_post_etiquetas_fk_2.png](imgs/platziblog_tabla_post_etiquetas_fk_2.png)

Ligamos las llaves foráneas para etiquetas_id

![platziblog_tabla_post_etiquetas_etiquetas_fk_1.png](imgs/platziblog_tabla_post_etiquetas_etiquetas_fk_1.png)

![platziblog_tabla_post_etiquetas_etiquetas_fk_2.png](imgs/platziblog_tabla_post_etiquetas_etiquetas_fk_2.png)

#### Reverse Engineer

Seleccionamos la opción Database para acceder a reverse engineer
![reverse_engineer_1](imgs/reverse_engineer_1.png)

![reverse_engineer_2](imgs/reverse_engineer_2.png)

![reverse_engineer_3](imgs/reverse_engineer_3.png)

![reverse_engineer_4](imgs/reverse_engineer_4.png)

![reverse_engineer_5](imgs/reverse_engineer_5.png)

![reverse_engineer_6](imgs/reverse_engineer_6.png)

![reverse_engineer_7](imgs/reverse_engineer_7.png)
...
![teoria_conjuntos](imgs/Teoria_conjuntos.jpg)

![teoria_conjuntos_sentencias](imgs/teoria_conjuntos_sentencias.jpg)
...
* sise quiere hacer que los meses esten ordenados usar
...
![GROUP_CONCAT](imgs/GROUP_CONCAT.png)
...
![jerarquia_firestore](imgs/jerarquia_firestore.png)
...
Para esta clase creamos una bd en firebase [https://console.firebase.google.com/u/0/?pli=1](https://console.firebase.google.com/u/0/?pli=1)

Seguimos  los pasos sencillos de la pagina para crear nuestra base de datos "platziblog"

Creamos proyecto

![firebase_intro_1](imgs/firebase_intro_1.png)

![firebase_intro_2](imgs/firebase_intro_2.png)

![firebase_intro_3](imgs/firebase_intro_3.png)

Panel Inicial

![firebase_intro_4](imgs/firebase_intro_4.png)

Para crear una Top level collection (las que estan a nivel de la ruta principal) damos en simbolo plus, y creamos /people

![firebase_intro_5](imgs/firebase_intro_5.png)

![firebase_intro_6](imgs/firebase_intro_6.png)

![firebase_intro_7](imgs/firebase_intro_7.png)
...
![firebase_tipos_datos_1](imgs/firebase_tipos_datos_1.png)

![firebase_tipos_datos_2](imgs/firebase_tipos_datos_2.png)

![firebase_tipos_datos_3](imgs/firebase_tipos_datos_3.png)

![firebase_tipos_datos_4](imgs/firebase_tipos_datos_4.png)
...
![colecciones_vs_subcolecciones_1](imgs/colecciones_vs_subcolecciones_1.png)

![colecciones_vs_subcolecciones_2](imgs/colecciones_vs_subcolecciones_2.png)

![colecciones_vs_subcolecciones_3](imgs/colecciones_vs_subcolecciones_3.png)

![colecciones_vs_subcolecciones_4](imgs/colecciones_vs_subcolecciones_4.png)

![colecciones_vs_subcolecciones_5](imgs/colecciones_vs_subcolecciones_5.png)

![colecciones_vs_subcolecciones_6](imgs/colecciones_vs_subcolecciones_6.png)
...
![Platziblog_firebase_1](imgs/Platziblog_firebase_1.png)

![Platziblog_firebase_2](imgs/Platziblog_firebase_2.png)

Creamosen top level la coleccion usuarios

![Platziblog_firebase_3](imgs/Platziblog_firebase_3.png)

Creamos la top level posts con dos articulos

![Platziblog_firebase_4](imgs/Platziblog_firebase_4.png)

![Platziblog_firebase_5](imgs/Platziblog_firebase_5.png)
...
![Platziblog_firebase_6](imgs/Platziblog_firebase_6.png)

![Platziblog_firebase_7](imgs/Platziblog_firebase_7.png)

Agregamos las referencias para las categorias

![Platziblog_firebase_8](imgs/Platziblog_firebase_8.png)

![Platziblog_firebase_9](imgs/Platziblog_firebase_9.png)

Finalmente agregamos las subcolecciones etiquetas a los posts en agregar coleccion

![Platziblog_firebase_10](imgs/Platziblog_firebase_10.png)
